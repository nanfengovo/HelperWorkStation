<template>
    <div class="PLCCard">
            ...
            <el-table :data="PLCData" stripe style="width: 100%" >
                ...
                <el-table-column label="操作" width="300">
                    <template #default="scope">
                        <el-button type="primary" @click="EditFormVisable=true">修改</el-button>
        ...
        <!-- 插槽-编辑对话框 -->
    <el-dialog v-model="EditFormVisable" title="修改PLC配置" width="500">
        <el-form :model="form">
...
//修改
const EditFormVisable = (index: number, row: { id: number, iP: string, port: number }) => {
