...
const columns = [
    ...
    { key: 'dbName',dataKey:'dbName',  title: '数据点名称', width: 250, sortable: true },
    { key: 'remark',dataKey:'remark',  title: '备注', width: 400, sortable: true },
    { key: 'result',dataKey :'result', title: '结果', width: 150, sortable: true },
    { key: 'exceptionInfo', dataKey :'exceptionInfo', title: '异常信息', width: 200, sortable: true },
    { key: 'dateTime',dataKey :'dateTime', title: '日期时间', width: 220, sortable: true },
]
