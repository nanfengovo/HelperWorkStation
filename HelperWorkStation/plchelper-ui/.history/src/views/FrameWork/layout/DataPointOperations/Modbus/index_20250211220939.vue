...
const form = ref<{id?:number, plcName: string,slaveId: number,functionCode:string,startAddress:string, num:number, modbusName: string}>({id:0, plcName: '',slaveId: 1,functionCode:'',startAddress:'', num:1, modbusName: ''});
