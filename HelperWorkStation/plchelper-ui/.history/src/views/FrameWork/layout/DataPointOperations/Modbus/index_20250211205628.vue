...
const form = ref<{id?:number, modbusName: string,slaveId: number,functioncode:string,address:string, num:number, modbusname: string}>({id:0, modbusName: '',slaveId: 1,functioncode:'',address:'', num:1, modbusname: ''});
