            ...
            <div class="modbus-header">
                ...
                <el-form :model="modbusConfig" class="modbusConfig-form">
                    ...
                    <el-form-item label="Address" >
                        <el-input v-model="modbusConfig.address" placeholder="请输入地址" />
                    </el-form-item>
                </el-form>
            </div>
        </el-card>
...
const functionCodes =[
    {
        label: '01 Read Coils（0x）',
        value: '01 Read Coils（0x）'
    },
    {
        label: '02 Read Discrete Inputs (1x)',
        value: '02 Read Discrete Inputs (1x)'
    },
    {
        label: '03 Read Holding Registers (4x)',
        value: '03 Read Holding Registers (4x)'
    },
    {
        label: '04 Read Input Registers (3x)',
        value: '04 Read Input Registers (3x)'
    },
    {
        label: '05 Write Single Coil',
        value: '05 Write Single Coil'
    },
    {
        label: '06 Write Single Register',
        value: '06 Write Single Register'
    },
    {
        label: '15 Write Multiple Coils',
        value: '15 Write Multiple Coils'
    },
    {
        label: '16 WriteMultipleRegisters',
        value: '16 WriteMultipleRegisters'
    }
]
