                ...
                <el-form :model="DBpointConfig" class="DBPointConfig-form">
                    <div class="content">
                        ...
                        <el-form-item label = "数据点名称:">
                            <el-input v-model="dbName" placeholder="数据点名称"  clearable style="width: 200px;"/>
                        </el-form-item>
                        <el-form-item label = "数据类型:">
                            <el-input v-model="dbType" placeholder="请输入数据类型"  clearable style="width: 200px;"/>
                        </el-form-item>
                        <el-form-item label = "DB块地址:">
                            <el-input  v-model="dbAddress" placeholder="请输入DB块地址"  clearable style="width: 200px;"/>
                        </el-form-item>
                        <el-form-item label = "偏移量:">
                            <el-input v-model="dbOffset" placeholder="请输入偏移量" clearable style="width: 200px;" />
                        </el-form-item>
                        <el-form-item label = "备注:">
                            <el-input v-model="remark" placeholder="请输入备注"  clearable style="width: 200px;"/>
                        </el-form-item>
