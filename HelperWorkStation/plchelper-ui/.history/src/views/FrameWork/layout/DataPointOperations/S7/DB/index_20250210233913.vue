...
const update = () => {
    const res = axios.put(`http://localhost:5264/api/DBPointConfig/UpdateDBPointConfig?id=${editForm.id}`, {
        S7Name: form.value.s7Name,
        DBName: form.value.dbName,
        DBType: form.value.dbType,
        DBAddress: form.value.dbAddress,
        DBOffset: form.value.dbOffset,
