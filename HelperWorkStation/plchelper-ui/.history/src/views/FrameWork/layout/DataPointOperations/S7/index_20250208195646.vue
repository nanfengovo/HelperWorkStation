    ...
    <div class="S7Card">
        ...
        <el-card style="width: 100%" shadow="always"  >
            <el-table :data="S7ConfigData" stripe style="width: 100%" >
                ...
                <el-table-column prop="name" label="S7配置名称" width="180" />
                <el-table-column prop="ip" label="IP地址" width="180" />
                <el-table-column prop="port" label="端口" width="100" />
                <el-table-column prop="cpuType" label="PLC类型" width="180" />
                <el-table-column prop="rack" label="Rack" width="180" />
                <el-table-column prop="slot" label="Slot" width="180" />
...
const S7ConfigData = ref<Array<{ id: number, name :string,iP: string, port: number,cputype: string,rack: string,slot: string}>>([]);
