...
const form = ref<{id?:number, selectedPLC: string,slaveId: number,functioncode:string,address:string, num:number, modbusname: string}>({id:0, selectedPLC: '',slaveId: 1,functioncode:'',address:'', num:1, modbusname: ''});
...
//编辑
//编辑
const Edit = (index: number, row: { id: number, selectedPLC: string,slaveId: number,functioncode:string,address:string, num:number, modbusname: string}) => {
    form.value = { ...row };
